...
namespace Hyl.Core.Caching
{
    public partial class RedisCacheManager : ICacheManager
    {
        ...
        //public RedisCacheManager(HylWebConfig config, IRedisConnectionWrapper connectionWrapper)
        public RedisCacheManager(IRedisConnectionWrapper connectionWrapper)
        {
            ...
            this._perRequestCacheManager = EngineContext.Current.Resolve<ICacheManager>("hyl_cache_per_request");
        ...
        public virtual T Get<T>(string key)
        {
            ...
            if (!rValue.HasValue)
             ...
             var result = JsonConvert.DeserializeObject<T>(rValue);
