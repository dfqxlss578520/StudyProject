$(document).ready(function () {
            ...
            buttons: {
                "OK": {
                    ...
                    click: function () {
                        //执行发布
                        var surveyId = $("#id").val();
                        window.location.href = publishSurveyUrl + '?surveyId=' + surveyId;//ctx + "/design/my-survey-design!devSurvey.action?surveyId=" + surveyId;
                    }
                },
                "llll": {
                    text: "继续设计",
                    ...
                    click: function () {
                        //$( this ).dialog( "close" );
                        var surveyId = $("#id").val();
                        window.location.href = editSurveyDesignUrl + '?surveyId=' + surveyId;// ctx + "/design/my-survey-design.action?surveyId=" + surveyId;
                    }
                },
                "CENCEL": {
                    text: "退出",
            ...
            buttons: {
                "OK": {
                    ...
                    click: function () {
                        //执行发布
                        var surveyId = $("#id").val();
                        window.location.href = editSurveyDesignUrl + '?surveyId=' + surveyId;
                    }
                },
                "CENCEL": {
                    text: "取消",
    ...
    $(".surveyStateBtn").click(function () {
        ...
        //var ctx = $("#ctx").val();
        var url = saveSurveyStateUrl;//ctx+"/design/my-survey!surveyState.action";
        var surveyId = $("#id").val();
